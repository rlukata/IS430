...
<html>
    ...
    <?php
        ...
        $sql = "SELECT Event_Clearance_Date, Event_Clearance_Description, District_Sector FROM Incidents ORDER BY District_Sector ASC LIMIT 0, 30";
        $result = $conn->query($sql);

        if ($result->num_rows > 0) {
            echo '<h1>Incidents by district sector ascending</h1>';
