...
<html>
    ...
    <?php
        ...
        $sql = "SELECT Event_Clearance_Date, Event_Clearance_Description, "
                ...
                . "FROM Incidents ORDER BY Event_Clearance_Date ASC LIMIT 0, 30";
        $result = $conn->query($sql);

        if ($result->num_rows > 0) 
        {
            echo '<h1>Incidents by time and date ascending</h1>';
            echo "<table><tr><th>Date/Time</th><th>Description</th><th>District Sector</th><th>Group</th><th>Subgroup</th></tr>";
            ...
            while($row = $result->fetch_assoc()) {
                echo "<tr><td>" . 
                        ...
                        $row["Event_Clearance_SubGroup"]. "</td></tr>";
            }
            echo "</table>";
        } else {
            echo "0 results";
